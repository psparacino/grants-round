...
export function RoundDetailForm(props: RoundDetailFormProps) {
  ...
  const defaultRoundMetadata = {
    ...
    applicationsStartTime: new Date(0),
  };
                        ...
                        render={({ field }) => (
                          <Datetime
                            ...
                            inputProps={{
                              ...
                              placeholder: "",
                              disabled: watch("votingStrategy") === "QFRelay",
                              className:
                                "block w-full border-0 p-0 text-gray-900 placeholder-grey-40  0 focus:ring-0 text-sm disabled:opacity-50",
                            }}
          ...
          <div>
            ...
            <div className="mt-1 mb-2 shadow-sm block rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
              <VotingStrategyButton
                errors={props.errors}
                voting={props.votingOptions.find(
                  (t) => t.strategy === formValues.votingStrategy
                )}
              />
              <Transition
                show={open}
